...
// 	protoc        v3.19.1
// source: justeat/last-mile-driver-arriving-at-delivery-address.proto
...
type LastMileDriverArrivingAtDeliveryAddress struct {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) Reset() {
	*x = LastMileDriverArrivingAtDeliveryAddress{}
	if protoimpl.UnsafeEnabled {
		mi := &file_justeat_last_mile_driver_arriving_at_delivery_address_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LastMileDriverArrivingAtDeliveryAddress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LastMileDriverArrivingAtDeliveryAddress) ProtoMessage() {}

func (x *LastMileDriverArrivingAtDeliveryAddress) ProtoReflect() protoreflect.Message {
	mi := &file_justeat_last_mile_driver_arriving_at_delivery_address_proto_msgTypes[0]
...
// Deprecated: Use LastMileDriverArrivingAtDeliveryAddress.ProtoReflect.Descriptor instead.
func (*LastMileDriverArrivingAtDeliveryAddress) Descriptor() ([]byte, []int) {
	return file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDescGZIP(), []int{0}
}

func (x *LastMileDriverArrivingAtDeliveryAddress) GetPartnerOrderId() string {
	if x != nil {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetOrderReference() string {
	if x != nil {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetFriendlyOrderReference() string {
	if x != nil {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetRestaurantId() int32 {
	if x != nil {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetDeliveryPartnerName() string {
	if x != nil {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetDeliveryPartnerId() int32 {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetDeliveryPartnerPickupTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetDeliveryAddress() *Location {
	if x != nil {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetRestaurantAddress() *Location {
	if x != nil {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetOriginalEventTimestamp() *timestamppb.Timestamp {
	if x != nil {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetConfidence() *Confidence {
	if x != nil {
		return x.Confidence
	}
	return nil
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetTimeStamp() *timestamppb.Timestamp {
	if x != nil {
		return x.TimeStamp
	}
	return nil
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetRaisingComponent() string {
	if x != nil {
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetTenant() string {
	if x != nil {
		return x.Tenant
	}
	return ""
...
func (x *LastMileDriverArrivingAtDeliveryAddress) GetConversation() string {
	if x != nil {
...
var File_justeat_last_mile_driver_arriving_at_delivery_address_proto protoreflect.FileDescriptor

var file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDesc = []byte{
	0x0a, 0x3b, 0x6a, 0x75, 0x73, 0x74, 0x65, 0x61, 0x74, 0x2f, 0x6c, 0x61, 0x73, 0x74, 0x2d, 0x6d,
	0x69, 0x6c, 0x65, 0x2d, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x2d, 0x61, 0x72, 0x72, 0x69, 0x76,
	0x69, 0x6e, 0x67, 0x2d, 0x61, 0x74, 0x2d, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x2d,
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x6a,
	0x75, 0x73, 0x74, 0x65, 0x61, 0x74, 0x1a, 0x15, 0x66, 0x6c, 0x79, 0x74, 0x2f, 0x64, 0x65, 0x73,
	0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x17, 0x6a,
	0x75, 0x73, 0x74, 0x65, 0x61, 0x74, 0x2f, 0x6c, 0x61, 0x73, 0x74, 0x2d, 0x6d, 0x69, 0x6c, 0x65,
	...
	0x07, 0x0a, 0x27, 0x4c, 0x61, 0x73, 0x74, 0x4d, 0x69, 0x6c, 0x65, 0x44, 0x72, 0x69, 0x76, 0x65,
	0x72, 0x41, 0x72, 0x72, 0x69, 0x76, 0x69, 0x6e, 0x67, 0x41, 0x74, 0x44, 0x65, 0x6c, 0x69, 0x76,
	0x65, 0x72, 0x79, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x28, 0x0a, 0x10, 0x70, 0x61,
	...
	0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x3a, 0x64, 0x82, 0xb5, 0x18, 0x35, 0x6a, 0x75, 0x73, 0x74,
	0x65, 0x61, 0x74, 0x2e, 0x6c, 0x61, 0x73, 0x74, 0x2e, 0x6d, 0x69, 0x6c, 0x65, 0x2e, 0x64, 0x72,
	0x69, 0x76, 0x65, 0x72, 0x2e, 0x61, 0x72, 0x72, 0x69, 0x76, 0x69, 0x6e, 0x67, 0x2e, 0x61, 0x74,
	0x2e, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x2e, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0xa2, 0xbb, 0x18, 0x27, 0x4c, 0x61, 0x73, 0x74, 0x4d, 0x69, 0x6c, 0x65, 0x44, 0x72, 0x69,
	0x76, 0x65, 0x72, 0x41, 0x72, 0x72, 0x69, 0x76, 0x69, 0x6e, 0x67, 0x41, 0x74, 0x44, 0x65, 0x6c,
	0x69, 0x76, 0x65, 0x72, 0x79, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x16, 0x0a, 0x14,
	...
	0x79, 0x5f, 0x70, 0x61, 0x72, 0x74, 0x6e, 0x65, 0x72, 0x5f, 0x70, 0x69, 0x63, 0x6b, 0x75, 0x70,
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x9d, 0x01, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x6a, 0x75,
	0x73, 0x74, 0x65, 0x61, 0x74, 0x42, 0x2c, 0x4c, 0x61, 0x73, 0x74, 0x4d, 0x69, 0x6c, 0x65, 0x44,
	0x72, 0x69, 0x76, 0x65, 0x72, 0x41, 0x72, 0x72, 0x69, 0x76, 0x69, 0x6e, 0x67, 0x41, 0x74, 0x44,
	0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x50, 0x72,
...
var (
	file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDescOnce sync.Once
	file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDescData = file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDesc
)

func file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDescGZIP() []byte {
	file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDescOnce.Do(func() {
		file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDescData = protoimpl.X.CompressGZIP(file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDescData)
	})
	return file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDescData
}

var file_justeat_last_mile_driver_arriving_at_delivery_address_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_justeat_last_mile_driver_arriving_at_delivery_address_proto_goTypes = []interface{}{
	(*LastMileDriverArrivingAtDeliveryAddress)(nil), // 0: justeat.LastMileDriverArrivingAtDeliveryAddress
	(*timestamppb.Timestamp)(nil),                   // 1: google.protobuf.Timestamp
	(*Location)(nil),                                // 2: justeat.Location
	(*Confidence)(nil),                              // 3: justeat.Confidence
}
var file_justeat_last_mile_driver_arriving_at_delivery_address_proto_depIdxs = []int32{
	1, // 0: justeat.LastMileDriverArrivingAtDeliveryAddress.delivery_partner_pickup_time:type_name -> google.protobuf.Timestamp
	2, // 1: justeat.LastMileDriverArrivingAtDeliveryAddress.delivery_address:type_name -> justeat.Location
	2, // 2: justeat.LastMileDriverArrivingAtDeliveryAddress.restaurant_address:type_name -> justeat.Location
	1, // 3: justeat.LastMileDriverArrivingAtDeliveryAddress.original_event_timestamp:type_name -> google.protobuf.Timestamp
	3, // 4: justeat.LastMileDriverArrivingAtDeliveryAddress.confidence:type_name -> justeat.Confidence
	1, // 5: justeat.LastMileDriverArrivingAtDeliveryAddress.time_stamp:type_name -> google.protobuf.Timestamp
...
func init() { file_justeat_last_mile_driver_arriving_at_delivery_address_proto_init() }
func file_justeat_last_mile_driver_arriving_at_delivery_address_proto_init() {
	if File_justeat_last_mile_driver_arriving_at_delivery_address_proto != nil {
		return
	}
	file_justeat_last_mile_proto_init()
	file_justeat_options_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_justeat_last_mile_driver_arriving_at_delivery_address_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LastMileDriverArrivingAtDeliveryAddress); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_justeat_last_mile_driver_arriving_at_delivery_address_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_justeat_last_mile_driver_arriving_at_delivery_address_proto_goTypes,
		DependencyIndexes: file_justeat_last_mile_driver_arriving_at_delivery_address_proto_depIdxs,
		MessageInfos:      file_justeat_last_mile_driver_arriving_at_delivery_address_proto_msgTypes,
	}.Build()
	File_justeat_last_mile_driver_arriving_at_delivery_address_proto = out.File
	file_justeat_last_mile_driver_arriving_at_delivery_address_proto_rawDesc = nil
	file_justeat_last_mile_driver_arriving_at_delivery_address_proto_goTypes = nil
	file_justeat_last_mile_driver_arriving_at_delivery_address_proto_depIdxs = nil
}
